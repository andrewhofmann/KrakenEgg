...
export const ViewerModal = () => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 backdrop-blur-sm bg-black/50">
      <div role="dialog" aria-label="File Viewer" className="relative flex flex-col w-full max-w-4xl h-3/4 rounded-lg shadow-2xl" style={{ backgroundColor: 'var(--ke-bg-elevated)', border: '1px solid var(--ke-border)' }}>
        {/* Header */}
        <div className="flex items-center justify-between p-3 border-b border-[var(--ke-border)] shrink-0">
          ...
          <button aria-label="Close" onClick={hideViewer} className="p-1 rounded-md hover:bg-[var(--ke-bg-hover)] transition-colors" style={{ color: 'var(--ke-text-secondary)' }}>
            <X size={16} />
          </button>
        </div>

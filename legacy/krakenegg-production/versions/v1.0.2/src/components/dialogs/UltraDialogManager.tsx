...
import UltraCreateFileDialog from './UltraCreateFileDialog';
import UltraArchiveDialog from './UltraArchiveDialog';
import UltraNetworkDialog from './UltraNetworkDialog';
import UltraAboutDialog from './UltraAboutDialog';
...
const UltraDialogManager = ({ activeDialog, onCloseDialog, dialogData }: UltraDialogManagerProps) => {
  ...
  const renderDialog = () => {
    switch (activeDialog) {
      ...
      case 'createFile':
        return <UltraCreateFileDialog onClose={onCloseDialog} />;
      case 'archive':
      ...
      case 'about':
        return <UltraAboutDialog onClose={onCloseDialog} />;
      default:
        return null;
    }
  };

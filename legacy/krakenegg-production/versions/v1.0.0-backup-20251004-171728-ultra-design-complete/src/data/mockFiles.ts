...
import { isArchivePath, parseArchivePath, generateArchiveContents } from '../utils/archiveUtils';
...
export const generateMockFiles = (path: string): FileInfo[] => {
  ...
  if (isArchivePath(path)) {
    ...
    return generateArchiveContents(archivePath, internalPath);
  }
  ...
  switch (path) {
    ...
    default:
      ...
      return [
        ...
        createMockFile('app.exe', path, 16384, FileType.Executable),
